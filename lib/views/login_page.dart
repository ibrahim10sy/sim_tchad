...
class _LoginPageState extends State<LoginPage> {
 ...
 Future<void> init() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          const Color(0xFFF8FAFB), // Un gris très clair/bleuté pour le fond
      body: SafeArea(
        child: Center(
          // Centre le contenu verticalement si l'écran est grand
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          labelText: label,
          prefixIcon:
              Icon(icon, color: AppColors.primaryGreen.withOpacity(0.7)),
